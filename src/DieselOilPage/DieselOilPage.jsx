      ...
      <div className="content">
        ...
        <div className="product-list">
          <div className="product-card">
            <h2>POWER PLUS CF-4 | SAE 15W-40</h2>
            <p>
              Applications: Masterline DEO lubricant portfolio specially 
              designed for latest turbo charged, low emission high performance 
              diesel engines to ensure superior...
            </p>
          ...
          {/* Product 2 */}
          <div className="product-card">
            <h2>CHAMPION 20W-40 CF/SF</h2>
            <p>
              High Performance Diesel Engine Oil Applications: 
              Champion 20W-40 API CF/SF is high quality diesel 
              engine oil formulated with superior refined...
            </p>
            <button className="read-btn">Read More</button>
          </div>
          ...
          <div className="product-card">
            ...
            <p>
              High Performance Diesel Engine Oil Applications: 
              Power Plus 15W-40 API CF-4 is multigrade diesel 
              engine oil for new generation diesel...
            </p>
            <button className="read-btn">Read More</button>
          </div>
